...
import DatatablePstatus from "../yasserComponents/MenusComponents/Orderlist";
import DataTest from "../yasserComponents/MenusComponents/dataTestMenus";
import ModalCreate from "../yasserComponents/MenusComponents/ModalCreate";
function Menus() {
  ...
  return (
    <Fragment>
      ...
      {isModalOpen && (
        <ModalCreate isModalOpen={isModalOpen} handleModal={handleModal} />
      )}
      <DatatablePstatus dataMenus={DataTest} />
    </Fragment>
  );
}
